...
import dashboardActiveIcon from 'images/darhboard-icon.png';
import ordersIcon from 'images/orders-icon.png';
import ordersActiveIcon from 'images/orders-icon.png';
...
import myAccountActiveIcon from 'images/my-account-icon.png';
import storesIcon from 'images/stores-icon.png';
import storesActiveIcon from 'images/stores-icon.png';
...
import chatWithMeActiveIcon from 'images/chat-with-me-icon.png';
import createrCommunityIcon from 'images/creater-community-icon.png';
import createrCommunityActiveIcon from 'images/creater-community-icon.png';
...
export default function UserSider({ selectedRouters = [], redirectTo = () => {}, systemConfigs = []}) {
  ...
  const items = [
    ...
    getItem('Help', 'help', undefined, [
      ...
      getItem('Chat with me', ROUTERS.SELLER_CHAT_WITH_ME, <Icon src={chatWithMeIcon} activeSrc={chatWithMeActiveIcon} active={checkRouterMatchFn(ROUTERS.SELLER_CHAT_WITH_ME)} />),
      getItem('Creator community', ROUTERS.SELLER_CREATOR_COMMUNITY, <Icon src={createrCommunityIcon} activeSrc={createrCommunityActiveIcon} active={checkRouterMatchFn(ROUTERS.SELLER_CREATOR_COMMUNITY)} />),
    ]),
  ];
