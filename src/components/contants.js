...
export const TRANSACTION_STATUS_LABEL_VALUE_OPTIONS = [
  ...
  { label: TRANSACTION_STATUS_LABELS[STATE_VALUES.COMPLETED], value: STATE_VALUES.COMPLETED },
  { label: TRANSACTION_STATUS_LABELS[STATE_VALUES.PENDING], value: STATE_VALUES.PENDING },
  { label: TRANSACTION_STATUS_LABELS[STATE_VALUES.CANCEL], value: STATE_VALUES.CANCEL },
];
